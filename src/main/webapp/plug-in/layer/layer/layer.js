                ...
                return f.zIndex = g,
                    ...
                    function() {
                        ...
                        function() {
                            ...
                            for (var b = 0,
                                     c = f.btn.length; c > b; b++) a += '<a class="' + h[6] + (b == c-1 ? b : 0) + '">' + f.btn[b] + "</a>";
                ...
                f.ie6 && b.IE6(d),
                    d.find("." + h[6]).children("a").on("click",
                        function() {
                            var e = c(this).index();
                            //alert(b.index);
                            //alert(e+"    "+b.index+"   "+g.btn.length);
                            g["btn" + (e + 1)] && g["btn" + (e + 1)](b.index, d),
                                0 === e ? g.yes ? g.yes(b.index, d) : g["btn" + (e + 1)] || f.close(b.index) : (g.btn.length-1) === e ? a() : g["btn" + (e + 1)] || f.close(b.index)
                        }),
